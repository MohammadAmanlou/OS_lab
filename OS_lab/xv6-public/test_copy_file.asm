...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 33 08 00 00       	mov    $0x833,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 e4 0a 00 00       	mov    0xae4,%eax
 ...
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	bf e8 0a 00 00       	mov    $0xae8,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 7b6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 7c2:	00 00 00 
    if(p->s.size >= nunits){
