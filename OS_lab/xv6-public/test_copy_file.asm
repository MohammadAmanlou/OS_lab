 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 53 08 00 00       	mov    $0x853,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 08 0b 00 00       	mov    $0xb08,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 7e2:	00 00 00 
    if(p->s.size >= nunits){
