...
int main(int argc, char *argv[]){
  ...
  1a:	78 3e                	js     5a <main+0x5a>
	   printf(1, "Fork failed.\n");
	  }
	 else if(pid == 0){
  1c:	74 2d                	je     4b <main+0x4b>
  1e:	89 c3                	mov    %eax,%ebx
	   ...
	   wait();
  20:	e8 c6 02 00 00       	call   2eb <wait>
	   
	     int lifetime = get_process_lifetime(pid);
  25:	83 ec 0c             	sub    $0xc,%esp
  28:	53                   	push   %ebx
  29:	e8 5d 03 00 00       	call   38b <get_process_lifetime>
	     if(lifetime >= 0){
  2e:	83 c4 10             	add    $0x10,%esp
  31:	85 c0                	test   %eax,%eax
  33:	78 38                	js     6d <main+0x6d>
	       printf(1, "child process lifetime: %d ticks\n", lifetime);
  35:	52                   	push   %edx
  36:	50                   	push   %eax
  37:	68 d8 07 00 00       	push   $0x7d8
  3c:	6a 01                	push   $0x1
  3e:	e8 1d 04 00 00       	call   460 <printf>
  43:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  46:	e8 98 02 00 00       	call   2e3 <exit>
	   sleep(100);
  ...
  6b:	eb d9                	jmp    46 <main+0x46>
	       printf(1, "error getting process lifetime.\n");
  6d:	50                   	push   %eax
  6e:	50                   	push   %eax
  6f:	68 fc 07 00 00       	push   $0x7fc
  74:	6a 01                	push   $0x1
  76:	e8 e5 03 00 00       	call   460 <printf>
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	eb c6                	jmp    46 <main+0x46>
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d d0 0a 00 00    	mov    0xad0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
