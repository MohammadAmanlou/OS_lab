...
int main(){
  ...
  1e:	50                   	push   %eax
  1f:	50                   	push   %eax
  20:	68 38 08 00 00       	push   $0x838
  25:	6a 01                	push   $0x1
  27:	e8 a4 04 00 00       	call   4d0 <printf>
		sleep(100);
  ...
  4b:	6a 01                	push   $0x1
  4d:	e8 7e 04 00 00       	call   4d0 <printf>
			int pid = getpid();
  ...
  62:	50                   	push   %eax
  63:	68 59 08 00 00       	push   $0x859
  68:	6a 01                	push   $0x1
  6a:	e8 61 04 00 00       	call   4d0 <printf>
			exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 85 08 00 00       	mov    $0x885,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 34 0b 00 00       	mov    0xb34,%eax
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 38 0b 00 00       	mov    $0xb38,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 822:	00 00 00 
    if(p->s.size >= nunits){
