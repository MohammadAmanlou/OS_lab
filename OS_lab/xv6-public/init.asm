...
main(void)
{
  ...
  c3:	59                   	pop    %ecx
  c4:	5b                   	pop    %ebx
  c5:	68 b0 0b 00 00       	push   $0xbb0
  ca:	68 96 08 00 00       	push   $0x896
  cf:	e8 d7 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  d4:	58                   	pop    %eax
  d5:	5a                   	pop    %edx
  d6:	68 99 08 00 00       	push   $0x899
  db:	6a 01                	push   $0x1
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 04 09 00 00 	movzbl 0x904(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb fb 08 00 00       	mov    $0x8fb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
 ...
 814:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 817:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
