  ...
  18:	83 39 03             	cmpl   $0x3,(%ecx)
{
 ...
 143:	53                   	push   %ebx
 144:	53                   	push   %ebx
 145:	68 fc 08 00 00       	push   $0x8fc
 14a:	6a 02                	push   $0x2
 14c:	e8 1f 04 00 00       	call   570 <printf>
        exit();
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 53e:	56                   	push   %esi
 53f:	57                   	push   %edi
 540:	e8 9e fe ff ff       	call   3e3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b9:	e8 25 fe ff ff       	call   3e3 <write>
 ...
 619:	e8 c5 fd ff ff       	call   3e3 <write>
        putc(fd, c);
      } else {
 ...
 6a1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6a4:	e8 3a fd ff ff       	call   3e3 <write>
        ap++;
 ...
 6f4:	eb 1a                	jmp    710 <printf+0x1a0>
          s = "(null)";
 6f6:	bb 3f 09 00 00       	mov    $0x93f,%ebx
        while(*s != 0){
 ...
 71b:	57                   	push   %edi
 71c:	53                   	push   %ebx
 71d:	e8 c1 fc ff ff       	call   3e3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 745:	a1 fc 0b 00 00       	mov    0xbfc,%eax
{
 ...
 766:	73 10                	jae    778 <free+0x38>
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	a3 fc 0b 00 00       	mov    %eax,0xbfc
}
 797:	5e                   	pop    %esi
 798:	5f                   	pop    %edi
 799:	5d                   	pop    %ebp
 ...
 7b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7ba:	a3 fc 0b 00 00       	mov    %eax,0xbfc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7e0:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 829:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
 ...
 83b:	e8 0b fc ff ff       	call   44b <sbrk>
  if(p == (char*)-1)
 ...
 852:	e8 e9 fe ff ff       	call   740 <free>
  return freep;
 857:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 ...
 884:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 887:	a3 fc 0b 00 00       	mov    %eax,0xbfc
}
 ...
 89e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 fc 0b 00 00 00 	movl   $0xc00,0xbfc
 8a7:	0c 00 00 
    base.s.size = 0;
 8aa:	bf 00 0c 00 00       	mov    $0xc00,%edi
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 00 0c 00 00 00 	movl   $0xc00,0xc00
 8b6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8bb:	c7 05 04 0c 00 00 00 	movl   $0x0,0xc04
 8c2:	00 00 00 
    if(p->s.size >= nunits){
